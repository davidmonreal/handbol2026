...
import { EventEditPlayer } from './EventEditPlayer';

interface EventItemProps {
    event: MatchEvent;
}

type EditingField = 'category' | 'zone' | 'result' | 'player' | null;
...
export const EventItem = ({ event }: EventItemProps) => {
    ...
    return (
        <div
            className={`p-3 transition-colors ${justSaved ? 'bg-green-50' : 'hover:bg-gray-50'}`}
        >
            {/* First Line: Time, Player, Delete */}
            <div className="flex items-center justify-between mb-1">
                <div className="flex items-center gap-2 text-sm">
                    ...
                    {editingField === 'player' ? (
                        ...
                        <button
                            onClick={() => setEditingField('player')}
            ...
            <div className="mt-1">
                {editingField === 'result' ? (
                    ...
                    <button
                        onClick={() => setEditingField('result')}
                    ...
                    >
                        <div className="flex flex-wrap items-center gap-2">
                            ...
                            {/* Edit Icon */}
                            <span className="ml-auto opacity-0 group-hover:opacity-100 text-gray-400 transition-opacity">
                                <Edit2 size={14} />
                            </span>
                        </div>
                    </button>
