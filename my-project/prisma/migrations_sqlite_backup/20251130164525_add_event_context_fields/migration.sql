...
INSERT INTO "new_GameEvent" ("distance", "goalZone", "id", "isCollective", "matchId", "playerId", "position", "sanctionType", "subtype", "teamId", "timestamp", "type") SELECT "distance", "goalZone", "id", "isCollective", "matchId", "playerId", "position", "sanctionType", "subtype", "teamId", "timestamp", "type" FROM "GameEvent";
