...
describe('SeasonService', () => {
    ...
    it('getAll calls repository.findAll', async () => {
        const mockSeasons = [{ id: '1', name: '2024-2025', startDate: new Date(), endDate: new Date() }];
        (repository.findAll as any).mockResolvedValue(mockSeasons);
    ...
    it('getById calls repository.findById', async () => {
        ...
        (repository.findById as any).mockResolvedValue(mockSeason);
    ...
    it('create calls repository.create with valid data', async () => {
        ...
        (repository.create as any).mockResolvedValue(createdSeason);
    ...
    it('update calls repository.update', async () => {
        ...
        (repository.update as any).mockResolvedValue(updatedSeason);
    ...
    it('delete calls repository.delete', async () => {
        ...
        (repository.delete as any).mockResolvedValue(deletedSeason);
